...
/**
 * Handle WebSocket /api/stream - Proxy WebSocket connection to content generator worker
 * Uses traditional service binding fetch (not RPC) for WebSocket proxying
 */
